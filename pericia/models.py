...
class CadEquipamento(models.Model):
...
class VerificacaoCadAdm(models.Model):
    ...
    data_verificacao = models.DateField(default=now(),blank=True)
    data_toi = models.DateField(default=now(),blank=True)
...
class RequisitosAdm(models.Model):
    numero_do_processo = models.OneToOneField(VerificacaoCadAdm, primary_key=True)
...
class RequisitosTecnicos(models.Model):
    numero_do_processo = models.OneToOneField(VerificacaoCadAdm, primary_key=True)
...
class RequisitosMetrologicos(models.Model):
    numero_do_processo = models.OneToOneField(VerificacaoCadAdm, primary_key=True)
...
class ProcedimentoPericia(models.Model):
